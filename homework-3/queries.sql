...
SELECT customers.company_name AS customer, CONCAT(employees.first_name, ' ', employees.last_name) AS fio_employee
FROM customers
...
-- Комментарий: как работает последнее я хз, в занятии не было оговорено про оператор ANY